...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2015 at 06:08 AM
...
(31, 11, 5, 2, '2015-04-11 00:00:00', 3),
(32, 11, 1, 1, '2015-04-06 00:00:00', 2);
...
--
-- Dumping data for table `booking_refreshments`
--

INSERT INTO `booking_refreshments` (`booking_id`, `item_id`, `item_qty`) VALUES
(1, 1, 2),
(3, 3, 2),
(4, 2, 1),
(6, 3, 2),
...
(11, 'Shouri', 'shouri@gmail.com', 'shuori', '8856', '9984536785');
...
--
ALTER TABLE `booking`
MODIFY `booking_id` int(8) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
--
...
ADD CONSTRAINT `booking_refreshments_ibfk_3` FOREIGN KEY (`booking_id`) REFERENCES `booking` (`booking_id`) ON DELETE CASCADE ON UPDATE CASCADE;
